...
![image](/assets/images/1D CNN stock forcasting images/foreigner_result_a.png){: width="80%" height="80%"}
...
## 모델 선정
![image](/assets/images/1D CNN stock forcasting images/model_define.png){: width="70%" height="70%"}
